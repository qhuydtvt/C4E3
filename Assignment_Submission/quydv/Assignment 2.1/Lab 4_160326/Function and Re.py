...
# result = footer_box.find_all(href = re.compile("quangcao"))
# print(result)

def menu_without_advertise(href):
    return href and not re.compile("tinhte.vn").search(href)

result = footer_box.find_all(href = menu_without_advertise)
print(result)